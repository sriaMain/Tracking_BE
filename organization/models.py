...
class Organisation(models.Model):
    ...
    created_by = models.ForeignKey(
        'authentication.User', on_delete=models.SET_NULL, null=True, related_name='organisations_created_by'
    )
    modified_by = models.ForeignKey(
        'authentication.User', on_delete=models.SET_NULL, null=True, related_name='organisations_modified_by'
    )
