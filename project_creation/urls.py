...
from .views import ClientListCreateAPIView, ClientDetailAPIView,ProjectListCreateAPIView,ProjectDetailAPIView,IdView,ClientPocCreateAPIView, ClientPocDetailAPIView  
